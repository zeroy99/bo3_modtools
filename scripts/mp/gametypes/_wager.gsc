...
REGISTER_SYSTEM( "wager", &__init__, undefined )
...
function init()
{
	if ( GameModeIsMode( GAMEMODE_WAGER_MATCH ) )
	{
		level.wagerMatch = 1;
...
function help_game_end()
{
	...
	for ( ;; )
	{
		...
		WAIT_SERVER_FRAME; // in case multiple players are eliminated simultaneously
