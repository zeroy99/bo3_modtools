...
function __init__()
{
	clientfield::register( "allplayers", "shock_field" , VERSION_SHIP, 1, "int" );
	
	ability_player::register_gadget_activation_callbacks( GADGET_TYPE_SHOCK_FIELD, &gadget_shock_field_on, &gadget_shock_field_off );
	ability_player::register_gadget_possession_callbacks( GADGET_TYPE_SHOCK_FIELD, &gadget_shock_field_on_give, &gadget_shock_field_on_take );
	ability_player::register_gadget_flicker_callbacks( GADGET_TYPE_SHOCK_FIELD, &gadget_shock_field_on_flicker );
	ability_player::register_gadget_is_inuse_callbacks( GADGET_TYPE_SHOCK_FIELD, &gadget_shock_field_is_inuse );
	ability_player::register_gadget_is_flickering_callbacks( GADGET_TYPE_SHOCK_FIELD, &gadget_shock_field_is_flickering );
...
{
	if ( IS_TRUE(self.shock_field_zap_sound) )
		return;
