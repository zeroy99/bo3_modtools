...
REGISTER_SYSTEM( "gadget_smokescreen", &__init__, undefined )

function __init__()
{
	ability_player::register_gadget_activation_callbacks( GADGET_TYPE_SMOKESCREEN, &gadget_smokescreen_on, &gadget_smokescreen_off );
	ability_player::register_gadget_possession_callbacks( GADGET_TYPE_SMOKESCREEN, &gadget_smokescreen_on_give, &gadget_smokescreen_on_take );
	ability_player::register_gadget_flicker_callbacks( GADGET_TYPE_SMOKESCREEN, &gadget_smokescreen_on_flicker );
	ability_player::register_gadget_is_inuse_callbacks( GADGET_TYPE_SMOKESCREEN, &gadget_smokescreen_is_inuse );
	ability_player::register_gadget_is_flickering_callbacks( GADGET_TYPE_SMOKESCREEN, &gadget_smokescreen_is_flickering );
	ability_player::register_gadget_primed_callbacks( GADGET_TYPE_SMOKESCREEN, &gadget_smokescreen_is_primed );
