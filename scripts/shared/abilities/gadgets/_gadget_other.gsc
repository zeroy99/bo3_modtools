...
REGISTER_SYSTEM( "gadget_other", &__init__, undefined )

function __init__()
{
	ability_player::register_gadget_activation_callbacks( GADGET_TYPE_OTHER, &gadget_other_on_activate, &gadget_other_on_off );
	ability_player::register_gadget_possession_callbacks( GADGET_TYPE_OTHER, &gadget_other_on_give, &gadget_other_on_take );
	ability_player::register_gadget_flicker_callbacks( GADGET_TYPE_OTHER, &gadget_other_on_flicker );
	ability_player::register_gadget_is_inuse_callbacks( GADGET_TYPE_OTHER, &gadget_other_is_inuse );
	ability_player::register_gadget_is_flickering_callbacks( GADGET_TYPE_OTHER, &gadget_other_is_flickering );
	ability_player::register_gadget_ready_callbacks( GADGET_TYPE_OTHER, &gadget_other_ready );
