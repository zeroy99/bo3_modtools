...
REGISTER_SYSTEM( "gadget_security_breach", &__init__, undefined )

function __init__()
{
	ability_player::register_gadget_activation_callbacks( GADGET_TYPE_SECURITY_BREACH, &gadget_security_breach_on, &gadget_security_breach_off );
	ability_player::register_gadget_possession_callbacks( GADGET_TYPE_SECURITY_BREACH, &gadget_security_breach_on_give, &gadget_security_breach_on_take );
	ability_player::register_gadget_flicker_callbacks( GADGET_TYPE_SECURITY_BREACH, &gadget_security_breach_on_flicker );
	ability_player::register_gadget_is_inuse_callbacks( GADGET_TYPE_SECURITY_BREACH, &gadget_security_breach_is_inuse );
	ability_player::register_gadget_is_flickering_callbacks( GADGET_TYPE_SECURITY_BREACH, &gadget_security_breach_is_flickering );
	ability_player::register_gadget_primed_callbacks( GADGET_TYPE_SECURITY_BREACH, &gadget_security_breach_is_primed );
