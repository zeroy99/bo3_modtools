...
REGISTER_SYSTEM( "gadget_exo_breakdown", &__init__, undefined )

function __init__()
{
	ability_player::register_gadget_activation_callbacks( GADGET_TYPE_EXO_BREAKDOWN, &gadget_exo_breakdown_on, &gadget_exo_breakdown_off );
	ability_player::register_gadget_possession_callbacks( GADGET_TYPE_EXO_BREAKDOWN, &gadget_exo_breakdown_on_give, &gadget_exo_breakdown_on_take );
	ability_player::register_gadget_flicker_callbacks( GADGET_TYPE_EXO_BREAKDOWN, &gadget_exo_breakdown_on_flicker );
	ability_player::register_gadget_is_inuse_callbacks( GADGET_TYPE_EXO_BREAKDOWN, &gadget_exo_breakdown_is_inuse );
	ability_player::register_gadget_is_flickering_callbacks( GADGET_TYPE_EXO_BREAKDOWN, &gadget_exo_breakdown_is_flickering );
	ability_player::register_gadget_primed_callbacks( GADGET_TYPE_EXO_BREAKDOWN, &gadget_exo_breakdown_is_primed );
