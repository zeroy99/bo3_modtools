...
REGISTER_SYSTEM( "gadget_active_camo", &__init__, undefined )

function __init__()
{
	ability_player::register_gadget_activation_callbacks( GADGET_TYPE_ACTIVE_CAMO, &camo_gadget_on, &camo_gadget_off );
	ability_player::register_gadget_possession_callbacks( GADGET_TYPE_ACTIVE_CAMO, &camo_on_give, &camo_on_take );
	ability_player::register_gadget_flicker_callbacks( GADGET_TYPE_ACTIVE_CAMO, &camo_on_flicker );
	ability_player::register_gadget_is_inuse_callbacks( GADGET_TYPE_ACTIVE_CAMO, &camo_is_inuse );
	ability_player::register_gadget_is_flickering_callbacks( GADGET_TYPE_ACTIVE_CAMO, &camo_is_flickering );
