...
REGISTER_SYSTEM( "gadget_hero_weapon", &__init__, undefined )
...
function __init__()
{
	...
	ability_player::register_gadget_possession_callbacks( GADGET_TYPE_HERO_WEAPON, &gadget_hero_weapon_on_give, &gadget_hero_weapon_on_take );
	ability_player::register_gadget_flicker_callbacks( GADGET_TYPE_HERO_WEAPON, &gadget_hero_weapon_on_flicker );
	ability_player::register_gadget_is_inuse_callbacks( GADGET_TYPE_HERO_WEAPON, &gadget_hero_weapon_is_inuse );
	ability_player::register_gadget_is_flickering_callbacks( GADGET_TYPE_HERO_WEAPON, &gadget_hero_weapon_is_flickering );
	ability_player::register_gadget_ready_callbacks( GADGET_TYPE_HERO_WEAPON, &gadget_hero_weapon_ready );
