...
REGISTER_SYSTEM( "gadget_misdirection", &__init__, undefined )

function __init__()
{
	ability_player::register_gadget_activation_callbacks( GADGET_TYPE_MISDIRECTION, &gadget_misdirection_on, &gadget_misdirection_off );
	ability_player::register_gadget_possession_callbacks( GADGET_TYPE_MISDIRECTION, &gadget_misdirection_on_give, &gadget_misdirection_on_take );
	ability_player::register_gadget_flicker_callbacks( GADGET_TYPE_MISDIRECTION, &gadget_misdirection_on_flicker );
	ability_player::register_gadget_is_inuse_callbacks( GADGET_TYPE_MISDIRECTION, &gadget_misdirection_is_inuse );
	ability_player::register_gadget_is_flickering_callbacks( GADGET_TYPE_MISDIRECTION, &gadget_misdirection_is_flickering );
	ability_player::register_gadget_primed_callbacks( GADGET_TYPE_MISDIRECTION, &gadget_misdirection_is_primed );
