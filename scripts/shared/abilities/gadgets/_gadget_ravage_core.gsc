...
REGISTER_SYSTEM( "gadget_ravage_core", &__init__, undefined )

function __init__()
{
	ability_player::register_gadget_activation_callbacks( GADGET_TYPE_RAVAGE_CORE, &gadget_ravage_core_on, &gadget_ravage_core_off );
	ability_player::register_gadget_possession_callbacks( GADGET_TYPE_RAVAGE_CORE, &gadget_ravage_core_on_give, &gadget_ravage_core_on_take );
	ability_player::register_gadget_flicker_callbacks( GADGET_TYPE_RAVAGE_CORE, &gadget_ravage_core_on_flicker );
	ability_player::register_gadget_is_inuse_callbacks( GADGET_TYPE_RAVAGE_CORE, &gadget_ravage_core_is_inuse );
	ability_player::register_gadget_is_flickering_callbacks( GADGET_TYPE_RAVAGE_CORE, &gadget_ravage_core_is_flickering );
