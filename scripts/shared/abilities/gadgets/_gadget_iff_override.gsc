...
REGISTER_SYSTEM( "gadget_iff_override", &__init__, undefined )

function __init__()
{
	ability_player::register_gadget_activation_callbacks( GADGET_TYPE_IFF_OVERRIDE, &gadget_iff_override_on, &gadget_iff_override_off );
	ability_player::register_gadget_possession_callbacks( GADGET_TYPE_IFF_OVERRIDE, &gadget_iff_override_on_give, &gadget_iff_override_on_take );
	ability_player::register_gadget_flicker_callbacks( GADGET_TYPE_IFF_OVERRIDE, &gadget_iff_override_on_flicker );
	ability_player::register_gadget_is_inuse_callbacks( GADGET_TYPE_IFF_OVERRIDE, &gadget_iff_override_is_inuse );
	ability_player::register_gadget_is_flickering_callbacks( GADGET_TYPE_IFF_OVERRIDE, &gadget_iff_override_is_flickering );
	ability_player::register_gadget_primed_callbacks( GADGET_TYPE_IFF_OVERRIDE, &gadget_iff_override_is_primed );
