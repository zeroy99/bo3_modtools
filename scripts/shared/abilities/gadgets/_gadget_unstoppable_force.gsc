...
function __init__()
{
	ability_player::register_gadget_activation_callbacks( GADGET_TYPE_UNSTOPPABLE_FORCE, &gadget_unstoppable_force_on, &gadget_unstoppable_force_off );
	ability_player::register_gadget_possession_callbacks( GADGET_TYPE_UNSTOPPABLE_FORCE, &gadget_unstoppable_force_on_give, &gadget_unstoppable_force_on_take );
	ability_player::register_gadget_flicker_callbacks( GADGET_TYPE_UNSTOPPABLE_FORCE, &gadget_unstoppable_force_on_flicker );
	ability_player::register_gadget_is_inuse_callbacks( GADGET_TYPE_UNSTOPPABLE_FORCE, &gadget_unstoppable_force_is_inuse );
	ability_player::register_gadget_is_flickering_callbacks( GADGET_TYPE_UNSTOPPABLE_FORCE, &gadget_unstoppable_force_is_flickering );

	callback::on_connect( &gadget_unstoppable_force_on_connect );
	
	clientfield::register( "toplayer", "unstoppableforce_state", VERSION_SHIP, 1, "int");
}
