...
REGISTER_SYSTEM( "gadget_servo_shortout", &__init__, undefined )

function __init__()
{
	ability_player::register_gadget_activation_callbacks( GADGET_TYPE_SERVO_SHORTOUT, &gadget_servo_shortout_on, &gadget_servo_shortout_off );
	ability_player::register_gadget_possession_callbacks( GADGET_TYPE_SERVO_SHORTOUT, &gadget_servo_shortout_on_give, &gadget_servo_shortout_on_take );
	ability_player::register_gadget_flicker_callbacks( GADGET_TYPE_SERVO_SHORTOUT, &gadget_servo_shortout_on_flicker );
	ability_player::register_gadget_is_inuse_callbacks( GADGET_TYPE_SERVO_SHORTOUT, &gadget_servo_shortout_is_inuse );
	ability_player::register_gadget_is_flickering_callbacks( GADGET_TYPE_SERVO_SHORTOUT, &gadget_servo_shortout_is_flickering );
	ability_player::register_gadget_primed_callbacks( GADGET_TYPE_SERVO_SHORTOUT, &gadget_servo_shortout_is_primed );
