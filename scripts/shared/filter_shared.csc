...
function enable_filter_water_sheeting( player, filterid )
	...
	setfilterpassenabled( player.localClientNum, filterid, 0, true, false, true );
	}
...
function enable_filter_vehicle_hijack_oor( player, filterid )
	...
	setfilterpassenabled( player.localClientNum, filterid, 0, true );
	setfilterpassconstant( player.localClientNum, filterid, 0, 1, 0.0 );
...
{
	setfilterpassmaterial( localClientNum, FILTER_INDEX_DROWN, passid, mapped_material_id( "generic_filter_drowning" ) );
	setfilterpassenabled( localClientNum, FILTER_INDEX_DROWN, passid, true, false, true );
}

function set_filter_drowning_damage_opacity( localClientNum, passid, opacity )
{
	setfilterpassconstant( localClientNum, FILTER_INDEX_DROWN, passid, 0, opacity );
}

function set_filter_drowning_damage_inner_radius( localClientNum, passid, inner )
{
	setfilterpassconstant( localClientNum, FILTER_INDEX_DROWN, passid, 1, inner );
}

function set_filter_drowning_damage_outer_radius( localClientNum, passid, outer )
{
	setfilterpassconstant( localClientNum, FILTER_INDEX_DROWN, passid, 2, outer );
}

function disable_filter_drowning_damage( localClientNum, passid )
{
	setfilterpassenabled( localClientNum, FILTER_INDEX_DROWN, passid, false );
}
