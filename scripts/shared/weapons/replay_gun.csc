...
#insert scripts\shared\weapons\replay_gun.gsh;
#insert scripts\shared\shared.gsh;
#insert scripts\shared\version.gsh;

#namespace replay_gun;

REGISTER_SYSTEM( "replay_gun", &__init__, undefined )

#define REPLAY_OUTLINE_MATERIAL	"mc/hud_outline_model_red"
...
function __init__()
{
	...
	duplicate_render::set_dr_filter_offscreen( "replay", 75, 
	                                ...
	                                DR_TYPE_OFFSCREEN, REPLAY_OUTLINE_MATERIAL, DR_CULL_ALWAYS  );
