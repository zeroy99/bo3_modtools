...
REGISTER_SYSTEM( "containers", &__init__, undefined )
...
function container_update( c_container )
{
	...
	e_trigger = containers::create_locker_trigger( c_container.m_s_container_instance.origin, n_radius, STR_OPEN_CONTAINER_MESSAGE );
