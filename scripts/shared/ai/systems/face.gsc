...
function PlayFaceThread( facialanim, str_script_alias, importance, notifyString, waitOrNot, timeToWait, toplayer )
{
	...
	DEFAULT( level.NumberOfImportantPeopleTalking, 0 );
	DEFAULT( level.TalkNotifySeed, 0 );
	DEFAULT( notifyString, "PlayFaceThread " + str_script_alias );
	DEFAULT( self.a, SpawnStruct() );
	DEFAULT( self.a.facialSoundDone, true );
	DEFAULT( self.isTalking, false );
